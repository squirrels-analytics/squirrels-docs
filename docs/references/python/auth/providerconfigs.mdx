...
<Expandable title="arguments" defaultOpen>
  ...
  <ResponseField name="server_metadata_path" type="str" default="/.well-known/oauth-authorization-server">
    Path to the OAuth authorization server metadata (used for discovery)
  </ResponseField>
