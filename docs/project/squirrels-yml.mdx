...
<Expandable title="properties" defaultOpen>
  ...
  <ResponseField name="major_version" type="integer" required>
    ...
    Increment this when there are breaking changes in the Squirrels datasets for instance. See below for more information.
  </ResponseField>
...
A how-to guide on hosting multiple Squirrels apps on one FastAPI server is coming soon.
