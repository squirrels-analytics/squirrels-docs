...
Create a new Python file (e.g., `main.py`) in your project directory. This file will initialize your Squirrels project and set up a FastAPI application.
...
For example, to run with auto-reload and a specific port:
