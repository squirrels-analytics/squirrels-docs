...
══════════════════════════════════════════════════
 ...
 🖥️ Application UI
  └─ Squirrels Studio: http://127.0.0.1:8000/project/expenses/v1/studio
     └─ (The following URL also redirects to studio: http://127.0.0.1:8000)

 🔌 MCP Server URLs
  ├─ Option 1:         http://127.0.0.1:8000/project/expenses/v1/mcp
  └─ Option 2:         http://127.0.0.1:8000/mcp

 📖 API Documentation
  ├─ Swagger UI:       http://127.0.0.1:8000/project/expenses/v1/docs
  ├─ ReDoc UI:         http://127.0.0.1:8000/project/expenses/v1/redoc
  └─ OpenAPI Spec:     http://127.0.0.1:8000/project/expenses/v1/openapi.json
